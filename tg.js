                ...
                v.jsx(Jn, {
                    children: v.jsxs(He, {
                        onClick: async function generateCodes() {
                            try {
                                setCodes([null, null, null, null]), setCurrentStatus("wait"), setProgress(0);
                                const newCodes = await Promise.all([stone3.generate(), stone3.generate(), stone3.generate(), stone3.generate()]);
                                setCodes(newCodes), setCurrentStatus("done"), setProgress(100);
                                const generatedCodeCount = parseInt(localStorage.getItem('generatedCodeCount') || '0');
                                const newCount = generatedCodeCount + 4;
                                localStorage.setItem('generatedCodeCount', newCount);
                ...
                v.jsx(Jn, {
                    children: v.jsxs(He, {
                        onClick: async function generateCodes() {
                            try {
                                setCodes([null, null, null, null]), setCurrentStatus("wait"), setProgress(0);
                                const newCodes = await Promise.all([bouncemasters3.generate(), bouncemasters3.generate(), bouncemasters3.generate(), bouncemasters3.generate()]);
                                setCodes(newCodes), setCurrentStatus("done"), setProgress(100);
                                const generatedCodeCount = parseInt(localStorage.getItem('generatedCodeCount') || '0');
                                const newCount = generatedCodeCount + 4;
                                localStorage.setItem('generatedCodeCount', newCount);
...
const frontier1 = "eb518c4b-e448-4065-9d33-06f3039f0fcb",
    frontier2 = "eb518c4b-e448-4065-9d33-06f3039f0fcb",
    frontier3 = new ro(frontier1, frontier2);
...
const count1 = "4bdc17da-2601-449b-948e-f8c7bd376553",
    count2 = "4bdc17da-2601-449b-948e-f8c7bd376553",
    count3 = new ro(count1, count2);
                ...
                v.jsx(Jn, {
                    children: v.jsxs(He, {
                        onClick: async function generateCodes() {
                            try {
                                setCodes([null, null, null, null]), setCurrentStatus("wait"), setProgress(0);
                                const newCodes = await Promise.all([count3.generate(), count3.generate(), count3.generate(), count3.generate()]);
                                setCodes(newCodes), setCurrentStatus("done"), setProgress(100);
                                const generatedCodeCount = parseInt(localStorage.getItem('generatedCodeCount') || '0');
                                const newCount = generatedCodeCount + 4;
                                localStorage.setItem('generatedCodeCount', newCount);
...
const cooking1 = "ed526e8c-e6c8-40fd-b72a-9e78ff6a2054",
    ...
    cooking3 = new ro(cooking1, cooking2);
                ...
                v.jsx(Jn, {
                    children: v.jsxs(He, {
                        onClick: async function generateCodes() {
                            try {
                                setCodes([null, null, null, null]), setCurrentStatus("wait"), setProgress(0);
                                const newCodes = await Promise.all([cooking3.generate(), cooking3.generate(), cooking3.generate(), cooking3.generate()]);
                                setCodes(newCodes), setCurrentStatus("done"), setProgress(100);
                                const generatedCodeCount = parseInt(localStorage.getItem('generatedCodeCount') || '0');
                                const newCount = generatedCodeCount + 4;
                                localStorage.setItem('generatedCodeCount', newCount);
                ...
                v.jsx(Jn, {
                    children: v.jsxs(He, {
                        onClick: async function generateCodes() {
                            try {
                                setCodes([null, null, null, null]), setCurrentStatus("wait"), setProgress(0);
                                const newCodes = await Promise.all([snake3.generate(), snake3.generate(), snake3.generate(), snake3.generate()]);
                                setCodes(newCodes), setCurrentStatus("done"), setProgress(100);
                                const generatedCodeCount = parseInt(localStorage.getItem('generatedCodeCount') || '0');
                                const newCount = generatedCodeCount + 4;
                                localStorage.setItem('generatedCodeCount', newCount);
